...
const PortFolioDashboard = () => {
  ...
  const [funds, setfunds] = useState([
    {
      ...
      returns_since_investment: 0.125,
    },
    {
      ...
      isn: "INF179K01YV8",
      nav_at_investment: 100,
      returns_since_investment: 0.102,
    },
    {
    ...
    },
    {
      ...
      isn: "INF846K01DP8",
      nav_at_investment: 100,
      returns_since_investment: 0.098,
    },
    {
  ...
  function calculateTotalOneDayReturn(funds:any) {
    ...
    let totalInvestment = funds.reduce((sum:any, fund:any) => sum + fund.amount, 0);
    let weightedReturn = funds.reduce((sum:any, fund:any) => sum + (fund.amount * (Math.pow(1 + fund.returns_since_investment, 1/365) - 1) * 100), 0) / totalInvestment;
              ...
              </div>
              {
                <div>
                  <div className="flex gap-2 items-center mb-6">
                    ...
                    >
                      {data.return > 0 ? "+" : ""}
                      {id===0?calculateTotalOneDayReturn(funds): data.return}%
                    </text>
                  </div>
                  {id===0 &&<div className="flex gap-2 items-center mt-[-1.4rem] ml-4">
